...
const Pricing = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-50 p-4 md:p-8 font-sans animate-in fade-in duration-500">
                    ...
                    <div className="bg-slate-800/40 backdrop-blur-md border border-indigo-500/20 rounded-2xl p-8 relative overflow-hidden">
                        ...
                        <div className="space-y-4 relative z-10">
                            ...
                            <button
                                ...
                                className="w-full mt-8 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 px-6 rounded-xl shadow-lg shadow-indigo-500/20 transition-all active:scale-[0.98]"
                            >
                                Proceed to Checkout
                            </button>
                        </div>
