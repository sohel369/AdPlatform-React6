        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Deep dive into your campaign metrics with live updates.</p>
                </div>
                <div className="flex gap-2">
                    <button onClick={handleExportCSV} className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors">
                        <Download size={16} /> CSV
                    </button>
                    <button onClick={handleExportPDF} className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-xl text-sm font-medium hover:bg-slate-800 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/50 p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-slate-800 mb-6">CTR Trends (Live)</h3>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/50 p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-slate-800 mb-6">Daily Impressions</h3>
                    <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/50 p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-slate-800 mb-6">Budget Utilization (%)</h3>
                    <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/50 p-6 shadow-sm">
                    <h3 className="text-sm font-bold text-slate-800 mb-6">Traffic by Device</h3>
